...
def main() -> None:
    ...
    product_review_stream = (
        ...
        .set_parallelism(1)
        .map(_rate_limit)  # Rate limit to 1 request per second to allow watermark to generate periodically.
        .set_parallelism(1)
        # For some reason, watermark is not generated when the rate_limit and
        # timestamp_and_watermarks are chained together.
