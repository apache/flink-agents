...
class AgentPlanPreflightTest {
    ...
    void returnsNullForValidPlan() throws Exception {
        ...
        assertThat(AgentPlanPreflight.findValidationError(planJson)).isNull();
    }
    ...
    void returnsTriggerConditionErrorMessage() throws Exception {
        ...
        String errorMessage = AgentPlanPreflight.findValidationError(planJson);
