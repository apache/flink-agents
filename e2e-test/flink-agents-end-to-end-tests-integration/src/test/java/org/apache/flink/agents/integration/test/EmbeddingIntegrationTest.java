...
import static org.apache.flink.agents.integration.test.OllamaPreparationUtils.hasApiKey;
...
public class EmbeddingIntegrationTest {
    ...
    @ParameterizedTest()
    @ValueSource(strings = {"OLLAMA", "OPENAI"})
    public void testEmbeddingIntegration(String provider) throws Exception {
        Assumptions.assumeTrue(
                OLLAMA.equals(provider) ? ollamaReady : hasApiKey(provider),
                String.format(
