...
/**
 * Example pipeline that runs {@link AgentWithOpenAI}. It falls back to the {@link
 * AgentWithResourceExample} mock pipeline if {@code OPENAI_API_KEY} is not configured.
 */
public class AgentWithOpenAIExample {

    /** Runs the example pipeline. */
    public static void main(String[] args) throws Exception {
        if (!AgentWithOpenAI.callingRealMode()) {
            System.err.println(
                    "OPENAI_API_KEY not set. Falling back to AgentWithResourceExample mock mode.");
