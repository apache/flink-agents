 ...
 *
 * <p>This prompt implementation uses a local template that can be either a string or a sequence of
 * ChatMessage objects. The template supports placeholder substitution using {variable} syntax.
 *
 * <p>Example usage:
 *
 * <pre>{@code
