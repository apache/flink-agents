...
class KafkaActionStateCleanupCoordinatorIntegrationTest {
    ...
    void testCommitsDeletesVerifiesAndRecoversBoundary() throws Exception {
        ...
        try (KafkaContainer kafka =
            ...
            configuration.set(KAFKA_ACTION_STATE_TOPIC_NUM_PARTITIONS, 2);
            try (KafkaActionStateStore ignored =
                    new KafkaActionStateStore(configuration, createKeyEncoder(128))) {
                // Exercise the exact topic configuration created by the production store.
            }
