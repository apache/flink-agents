 ...
 * action task will be invoked only once, and you should not call {@link #getGeneratedActionTask()}
 * to retrieve the next code block.
 */
public class JavaActionTask extends ActionTask {

    public JavaActionTask(Object key, Event event, Action action, RunnerContextImpl runnerContext) {
