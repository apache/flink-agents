...
public class KafkaActionStateStore implements ActionStateStore {
    ...
    KafkaActionStateStore(
        ...
        this(actionStates, agentConfiguration, producer, consumer, topic, keyEncoder, null);
    }
                ...
                NewTopic newTopic =
                        new NewTopic(
                                ...
                                agentConfiguration
                                        ...
                                        .shortValue());
                // Keep compaction, enable explicit prefix deletion, and disable Kafka's independent
                // time- and size-based deletion so retained recovery points remain available.
                newTopic.configs(
                        Map.of(
