...
public class PythonResourceAdapterImpl implements PythonResourceAdapter {
    ...
    private static final String FROM_JAVA_CHAT_MESSAGE =
            PYTHON_MODULE_PREFIX + "from_java_chat_message";

    private static final String UPDATE_JAVA_CHAT_MESSAGE =
            PYTHON_MODULE_PREFIX + "update_java_chat_message";
    ...
    public void open() {
        EmbeddedPythonEnvironment environment = environmentManager.createEnvironment();
    ...
    public ChatMessage fromPythonChatMessage(Object pythonChatMessage) {
        ...
        String roleValue =
                (String) interpreter.invoke(UPDATE_JAVA_CHAT_MESSAGE, pythonChatMessage, message);
