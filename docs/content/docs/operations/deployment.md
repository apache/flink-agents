...
The same persisted action state is also used by fine-grained durable execution, including reconciler-based recovery for durable calls that need to recover a terminal outcome after failure.
