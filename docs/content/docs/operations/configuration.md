...
| `tool-call.batch.timeout` | -1ms (disabled)            | Duration              | Overall timeout for one parallel tool-call batch. Non-positive disables it. On timeout, unfinished slots fail; already completed slots keep their outcome.                                                                                                      |
