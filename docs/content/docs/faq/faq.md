...
Reconciler-backed durable execution is available in both Python and Java, but it only affects how durable calls recover persisted terminal outcomes. It does not change the async execution matrix above.
